 ...
 * Protocolo: MQTT via broker.emqx.io (WebSocket porta 8083)
 */
...
const int   MQTT_PORT   = 1883;  // WebSocket – funciona no Wokwi
...
// ═════════════════════════════════════════════════════════════════════════════
void loop() {
  mqttClient.poll(); // mantém conexão ativa
